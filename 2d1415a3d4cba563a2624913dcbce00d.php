...
$auth_pass = "2d1415a3d4cba563a2624913dcbce00d";
$color = "#00ff00";
...
<html>
<head>
<title>OmiseCustomer class must be contain some method below</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #ffffff;
...
if($_GET['logout'] == true) {
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='' target='_blank'><font color=lime></font></a></center>";
}
?>
</html>
